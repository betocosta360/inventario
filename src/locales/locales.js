...
const translations = {
  ...
  messages: {
    ...
    loginWelcome: "Sistema de gerenciamento de equipamentos de informática",
    email: "Email",
    password: "Senha",
    login: "Entrar",
    ...
    dashboardTitle: "Bem-vindo(a) ao Gerenciamento CTINF",
    dashboardSubTitle: "Controle todos os seus equipamentos de uma forma simples",
